...
public class MainInterfaceActivity  extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener{

    private ContentFragment contentFragmet;
...
//                contentFragmet, (LinearLayout)findViewById(R.id.left_drawer), anim)
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition){;
        ...
        animator.start();
        ContentFragment contentFragment = ContentFragment.newInstatnce(this.res);
